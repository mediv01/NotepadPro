...
void AutoCompletion::showPathCompletion()
{
	...
	*/
	...
	generic_string autoCompleteEntries;
	{
		...
		{
			// Maximum number of entries to show. Without this it appears to the user like NotepadPro hangs when autocompleting
...
void AutoCompletion::insertMatchedChars(int character, const MatchedPairConf & matchedPairConf)
{
	...
	// if there's no user defined matched pair found, continue to check NotepadPro's one
