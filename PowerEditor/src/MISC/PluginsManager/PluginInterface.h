...
// You should implement (or define an empty function body) those functions which are called by NotepadPro plugin manager
...
// This API return always true now, since NotepadPro isn't compiled in ANSI mode anymore
